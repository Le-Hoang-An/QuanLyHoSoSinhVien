...
public class MonHocView extends JPanel {
    ...
    public Integer getSoTinChi() { return Integer.parseInt(txtSoTinChi.getText()); }
    ...
    if (!e.getValueIsAdjusting()) {
        ...
        if (selectedRow != -1) {
            txtMaMon.setText(table.getValueAt(selectedRow, 0).toString());
            txtTenMon.setText(table.getValueAt(selectedRow, 1).toString());
            txtSoTinChi.setText(table.getValueAt(selectedRow, 2).toString());
